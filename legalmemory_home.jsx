...
export default function LegalMemoryHome() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#0a1510] via-[#102117] to-[#0e1a14] text-[#f7f7f7] font-sans">
      {/* Hero Section */}
      <section className="flex flex-col items-center justify-center text-center py-24 px-4 bg-gradient-to-b from-[#0a1510] via-[#102117] to-[#0e1a14] relative overflow-hidden">
        {/* Background texture safely behind content */}
        ...
        <div className="relative z-10 flex flex-col items-center">
          {/* Title */}
          <motion.h1
            className="text-4xl md:text-6xl font-extrabold text-[#e3c77b] tracking-wide"
          ...
          {/* Call-to-action button (anchored link, guaranteed clickable) */}
          <a
      ...
      <section className="py-20 text-center bg-[#0d1c16]">
        ...
        <div className="flex justify-center gap-4 mt-6">
          <SocialLink platform="Instagram" url="https://www.instagram.com/legalmemoryai/" role="Follow us on Instagram" />
          <SocialLink platform="X" url="https://x.com/legalmemoryai" role="Visit our X profile" />
          <SocialLink platform="TikTok" url="https://www.tiktok.com/@legalmemory" role="Watch on TikTok" />
          <SocialLink platform="YouTube" url="https://www.youtube.com/@legalmemoryai" role="Subscribe on YouTube" />
        </div>
      </section>
    </div>
  );
...
function FeatureCard({ title, desc, icon }) {
  return (
    <motion.div
      className="bg-[#102117] p-6 rounded-2xl shadow-xl border border-[#e3c77b] hover:shadow-2xl hover:scale-105 transition duration-300"
      whileHover={{ scale: 1.05 }}
    >
      <div className="text-4xl mb-4 text-[#e3c77b]">{icon}</div>
      <h4 className="text-xl font-semibold mb-2 text-[#e3c77b]">{title}</h4>
